	...
	\begin{threeparttable}
		\scalebox{0.7}{
			\begin{tabular}{ccccccc}
				...
				\midrule
				NPM & a package manager for javascript & 165 & 32 & 9,075 & 1,217 & 5,329  \\
				\addlinespace
	...
	\begin{threeparttable}
		\scalebox{0.7}{
			\begin{tabular}{cccccccccc}
				\toprule
				Name & Description &  lines of code &  {\# of java files in latest release} & Number of Directories & LOC & Number of Functions & classes & Number of Statements \\
				\addlinespace
				\midrule
				ElasticSearch & cloud search engine & 424,007 & 4,050 & 831 & 644,637 & 35,762 & 5,967 & 198,944 \\
				\addlinespace
				\midrule
				Gauva & core library for java &  90,401 & 799 & 28 & 167,769 & 11,769 & 1,644 & 32,698\\    
				\addlinespace 
				\midrule
				JodaTime & library to subtitute default date library from java & 84,855 & 327 & 15 & 145,097 & 9,560 & 473 & 50,609 \\
				\addlinespace    
				\midrule
				Jsoup & Jason library for java &  13,672 & 80 & 14 & 19,419 & 1,487 & 154 & 7,980 \\
				\addlinespace
				\midrule
				JUnit & Unit test framework for java &  26,079 & 392 & 73 & 38,384 & 3,479 & 1,063 & 7,972  \\   
